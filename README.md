...
### 닉네임 기반의 커뮤니티 게시판
- 학생들은 운영자의 승인을 바탕으로 회원가입을 합니다.
- 건의사항, 잡담, 소통등을 할수있는 일반 게시판을 이용하며 친목을 도모합니다.
- 커뮤니티 게시글은 카테고리를 선택하여 조회할수 있습니다.
- 검색을 통해서 게시글, 사용자, 내용별로 검색할수 있습니다.
...
### 관리자 페이지 구현
- 게시판 관리자는 회원가입 승인, 게시글, 댓글삭제 등의 기능을 페이지에서 통합컨트롤이 가능합니다.
...
- 추후 파일업로드, 이미지파일 문서에 띄우기기능 업로드 예정
### ⭐️ 좋아요
- 좋아요로, 공감 표시 가능
- 좋아요는 회원 개개인이 따로 적용됨
- 좋아요 수를통해 추천과 비슷하게 글 상단으로 올리기 기능 구현예정 
---
### ⭐️ 1:1 쪽지
